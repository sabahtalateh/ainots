...
Для корректной работы **intelliscence** при импорте библиотек, установленных в выбранном для ноутбука окружении, необходимо установить для всего редактора тот-же интерпретатор, что установлен для ноутбука

1. В палитре команд `Cmd+Shif+P`
