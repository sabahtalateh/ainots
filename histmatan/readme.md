...
| Эпоха | Практическая задача | Математический инструмент | Ключевые персоны | Год |
|-------|---------------------|---------------------------|------------------|-----|
| **Античность** | Площадь круга, объём шара | Метод исчерпывания (прото-интеграл) | Евдокс, Архимед | ~250 до н.э. |
| **XVII век** | Мгновенная скорость | **Производная** | Ньютон, Лейбниц | ~1670 |
| **XVII век** | Касательная к кривой | Производная (геометрия) | Ферма, Барроу | ~1630-1670 |
| **XVII век** | Работа переменной силы, площади | **Интеграл** | Ньютон, Лейбниц | ~1670 |
| **XVII век** | Связь производной и интеграла | Формула Ньютона-Лейбница | Ньютон, Лейбниц, Барроу | ~1670 |
| **XVIII век** | Вычисление функций | **Ряды** (Тейлор, Фурье) | Тейлор, Эйлер, Фурье | 1715-1822 |
| **XVIII век** | Температура, волны | Частные производные, ДУ | Д'Аламбер, Эйлер, Лаплас | 1743-1780 |
| **XIX век** | Кризис оснований | **Предел** (ε-δ определение) | Коши, Больцано | 1817-1821 |
| **XIX век** | Строгий анализ | Формализация производной и интеграла | Вейерштрасс, Риман | 1854-1870 |
| **XIX век** | Непрерывность без производной | Патологические примеры | Вейерштрасс, Кантор | 1872 |
| **XX век** | Мера множеств | Интеграл Лебега | Лебег | 1902 |
...
- `01-ancient.md` — Античность: метод исчерпывания
- `02-derivative.md` — Рождение производной (задача о мгновенной скорости)
...
Начните с [задачи о мгновенной скорости](02-derivative.md) — это ключевая задача, которая привела к созданию дифференциального исчисления!
