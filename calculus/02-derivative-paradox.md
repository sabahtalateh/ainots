...
За время $t = 10 секунд$ автомобиль прошёл расстояние $S = 100 метров$. Высота линии графика в каждой точке $t$ показывает суммарно пройденное расстояние в момент времени $t$.
