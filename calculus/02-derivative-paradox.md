...
## Приращение пройденного пути

Можно построить столбиковый график приращений пройденного расстояние $ds(t) = s(t) - s(t - dt)$ для каждой секунды ($dt = 1$). 

**Пример:** $t = 5$ $ds(5) = s(5) - s(4) = 50 - 30.3 = 19.7$

<img src="../images/st1.png">

Вроде пока всё хорошо. Считаем насколько изменилось пройденное расстояние за секунду и у нас получается что-то похожее на график. Попробуем уменьшить интервал времени $dt$ за который считаем пройденное расстояние $ds$. Пусть будет $dt = 0.5$.

<img src="../images/st2.png">

Похоже намечается проблема, столбики стали ниже, при $dt = 0.1$ будут ещё ниже

<img src="../images/st3.png">

Что же случить с бедными столбиками при когда $dt$ будет приближаться к $0$.. Они тоже станут равными $0$. **Нужно другое решение**.., ведь **столбики ни в чём не виноваты**.
