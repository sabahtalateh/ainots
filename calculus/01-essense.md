...
**Производная интеграла равно самой функции**
...
- **Производная** функции этой площади (приращение площади при приращении $dx$) $\frac{dA(x)}{dx}$ равна исходной функции $f(x)$
