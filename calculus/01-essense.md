...
Эта запись обозначает **изменение площади при изменении $x$** и оно равно просто нашей функции.
...
$$\frac{dA}{dx} = \frac{A(3.001) - A(3)}{0.001}$$

Для $y = x^2$ первообразная $A(x) = \frac{x^3}{3}$, поэтому:

$$A(3) = \frac{3^3}{3} = \frac{27}{3} = 9$$

$$A(3.001) = \frac{3.001^3}{3} = \frac{27.027...}{3} \approx 9.009$$

$$dA = A(3.001) - A(3) \approx 9.009 - 9 = 0.009$$

$$\frac{dA}{dx} = \frac{0.009}{0.001} = 9 \approx 3^2$$
