...
Такая запись назвается **производной функции $A$**. И показывает что **изменение площади при изменении $x$** равно самой нашей функции $x^2$ или **высоте** тонкого **прямоугольника под графиком** в точке $x$ (при ширине прямоугольника $dx \rightarrow 0$).
