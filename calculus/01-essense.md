...
Эта запись обозначает **изменение площади при изменении $x$** и оно равно просто нашей функции (в любой точке $x$), а так-же высоте тонкого прямоугольника под графиком в некоторой точке.
