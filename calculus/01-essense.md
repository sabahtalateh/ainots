...
Попробуем выяснить, как связано изменение площади $dA$ и изменение $x$ на величину $dx$.
...
Отношение $\frac{dA}{dx} = \frac{A(3.001) - A(3)}{0.001}$ должно быть примерно равно $3^2 = 9$. Пока что мы не знаем, что за функция $A$, но мы выяснили её полезное свойство.
...
- **Производная** этой площади $\frac{dA}{dx}$ равна исходной функции $f(x)$

$$\boxed{\frac{dA}{dx} = f(x)}$$
