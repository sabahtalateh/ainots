...
- Определение целей проекта с точки зрения бизнеса
- Формулировка задачи Data Science
...
- Формирование финального датасета (обычно занимает 60-80% времени проекта)
...
**5. Evaluation (Оценка)**
- Проверка качества моделей по метрикам
- Оценка соответствия бизнес-целям
- Проверка на тестовых данных
- Принятие решения о готовности к развертыванию
