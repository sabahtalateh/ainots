...
Среднее: $\mu_A = \frac{3 + 3 + 3 + 3 + 3}{5} = 3$

Дисперсия:
$$
\sigma^2_A = \frac{(3-3)^2 + (3-3)^2 + (3-3)^2 + (3-3)^2 + (3-3)^2}{5} = \frac{0}{5} = 0
$$
...
Среднее: $\mu_B = \frac{1 + 2 + 3 + 4 + 5}{5} = 3$

Дисперсия:
$$
\sigma^2_B = \frac{(1-3)^2 + (2-3)^2 + (3-3)^2 + (4-3)^2 + (5-3)^2}{5} = \frac{4 + 1 + 0 + 1 + 4}{5} = \frac{10}{5} = 2
$$
...
- $D(aX + b) = a^2 D(X)$ (константа $b$ не влияет)
- Дисперсия всегда неотрицательна: $D(X) \geq 0$

**Правило "трёх сигм" (для нормального распределения):**
- ~68% значений лежат в пределах $\mu \pm \sigma$
- ~95% значений лежат в пределах $\mu \pm 2\sigma$
- ~99.7% значений лежат в пределах $\mu \pm 3\sigma$
