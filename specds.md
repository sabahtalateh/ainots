...
1. **Постановка бизнес-целей**
   - Определение стратегических целей проекта
   - Формулирование видения продукта
   - Приоритизация функциональности с точки зрения бизнеса
   - Установление критериев успеха проекта
   - Согласование целей со всеми заинтересованными сторонами

2. **Обеспечение ресурсами**
   - Выделение бюджета на проект
   - Предоставление доступа к необходимым данным
   - Обеспечение доступа к экспертам предметной области
   - Координация работы с внешними подрядчиками
   - Своевременное предоставление обратной связи и решений

3. **Постановка ограничений**
   - Определение временных рамок проекта
   - Установление бюджетных ограничений
   - Определение технических и юридических ограничений
   - Формулирование требований по безопасности и конфиденциальности
   - Установление стандартов качества

**Навыки и компетенции:**

1. **Предметная область**
   - Глубокое знание отрасли и бизнес-процессов
   - Понимание рынка и конкурентной среды
   - Знание специфики работы с данными в предметной области
   - Экспертиза в области применения продукта
...
3. **Переговорные навыки**
   - Ведение переговоров с различными заинтересованными сторонами
   - Разрешение конфликтов
   - Умение находить компромиссы
   - Защита интересов проекта
...
5. **Разработка метрик и управление по метрикам**
   - Определение ключевых показателей эффективности (KPI)
   - Разработка системы измерения успеха продукта
...
1. **Согласование содержания**
   - Детализация требований от Product Owner
   ...
   - Управление изменениями в scope проекта
   - Балансирование между требованиями заказчика и техническими возможностями

2. **Достижение целей продукта**
   - Планирование спринтов и релизов
   - Контроль выполнения плана разработки
   - Мониторинг прогресса по ключевым метрикам
   - Управление рисками проекта
   - Обеспечение качества продукта
   - Своевременная доставка функциональности

3. **Работа с командой (согласно продуктовым фреймворкам)**
   - Организация работы по Scrum, Kanban или другим методологиям
   - Проведение ежедневных стендапов и планирований
   - Фасилитация ретроспектив и демонстраций
   - Удаление блокеров для команды
   - Координация взаимодействия между разными специалистами
   - Создание условий для эффективной работы команды

**Навыки и компетенции:**

1. **Предметные области – бизнес и разработка**
   - Понимание бизнес-процессов и потребностей заказчика
   - Знание цикла разработки программного обеспечения
   - Базовые технические знания (архитектура, базы данных, API)
   - Понимание принципов UX/UI дизайна
   - Знакомство с технологическим стеком команды
...
2. **Управленческие навыки**
   ...
   - Риск-менеджмент
   - Координация кроссфункциональных команд

3. **Переговорные навыки**
   - Согласование требований со stakeholders
   - Управление ожиданиями
   - Разрешение конфликтов в команде
   - Аргументация технических решений для бизнеса
   - Работа с возражениями

4. **Мотиватор**
   - Вовлечение команды в достижение целей
...
5. **Разработка метрик и управление по метрикам**
   - Определение product metrics (активность пользователей, конверсия и т.д.)
   - Мониторинг velocity команды и burndown charts
   - Анализ эффективности функций продукта
   - A/B тестирование
   - Data-driven принятие решений

6. **Аналитические навыки**
   - Анализ требований и формулирование задач
   - Проведение research и изучение рынка
   - Выявление проблем пользователей
   - Работа с аналитическими инструментами
   - Критическое мышление

7. **Верхнеуровневые знания в области ИИ и машинного обучения**
   - Понимание возможностей и ограничений ML
   - Знание основных типов задач ML (классификация, регрессия, кластеризация)
   - Представление о процессе обучения моделей
   - Понимание метрик качества ML-моделей
   - Способность оценить применимость ML для решения бизнес-задач
   - Знание этапов MLOps и жизненного цикла ML-проектов
