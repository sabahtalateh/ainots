...
Возьмём последовательность $С_n = 1/n$, элементы такой последовательности следующие: ${1, 1/2, 1/3, 1/4, ...}$. Интуитивно понятно что предел такой последовательности равен $0$ при $x \rightarrow \infty$. Разберём это наглядно

Зададим $\varepsilon = 0.1$, тогда $N_\varepsilon = 1/0.2=5$. Это значит что все элементы последовательнсти начиная с номера **5** будут отличаться от предела (раного $0$) меньше чем на $\varepsilon = 0.1$

<img src="./images/lime02.png">
